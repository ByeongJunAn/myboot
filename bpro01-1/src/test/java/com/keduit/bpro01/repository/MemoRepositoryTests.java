...
//		Long mno = 100L;
	...
	public void testPageDefault() {
		...
		System.out.println("Total pages: " + result.getTotalPages()); //총 페이지 갯수
		System.out.println("Total count: " + result.getTotalElements()); 
		System.out.println("Page Number: " + result.getNumber());
		System.out.println("Page size: " + result.getSize()); // 페이지 당 데이터가 몇개인지 알려줌
...
//		Pageable pageable = PageRequest.of(0, 10, sort1);
	...
	@Transactional
	@Test
	public void testDeleteMemoqueryMethods() {
